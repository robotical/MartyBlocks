 ...
 */
 ...
 Blockly.Css.CONTENT = [
   ...
   */
   ...
   '.blocklyTuneFieldGroup {',
     'cursor: pointer;',
   '}',
   '.blocklyTuneFieldBorder {',
     'fill: white;',
     'stroke: rgba(255, 255, 255, 0.9);',
     'stroke-width: 1px;',
     'transition: stroke-width 120ms ease;',
   '}',
   '.blocklyTuneFieldGroup:hover .blocklyTuneFieldBorder,',
   '.blocklyTuneFieldGroup:focus-within .blocklyTuneFieldBorder {',
     'stroke-width: 1.5px;',
   '}',
   '.blocklyTuneFieldText {',
     'font-weight: 600;',
   '}',
