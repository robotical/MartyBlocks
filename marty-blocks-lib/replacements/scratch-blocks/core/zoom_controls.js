...
/**
 * Set the margin of the zoom controls. (exposed in gui)
 * @param {number} margin The margin of the zoom controls.
 */
Blockly.ZoomControls.prototype.setMarginSide = function(margin) {
  this.MARGIN_SIDE_ = margin;
  this.position();
};
