...
export default function LoadingSpinnerMarty() {
    const styles = {
        container: {
            width: "100%",
            height: "100%",
    ...
    return (
        <div style={styles.container}>
            <div>
                <svg style={styles.svg} data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="-8 -4 141.6 99.16">
                    <defs>
                        <style>
                            {`
                    ...
                    // #loadingSpinner_right_eyebrow {
                    //     transform-origin: 60% 75%;
                    //     animation: rotateRight 2s ease-in-out infinite;
                    // }
                    // #loadingSpinner_left_eyebrow {
                    //     transform-origin: 60% 75%;
              ...
              .sound-wave {
                ...
                stroke-width: 1.8px;
                opacity: 0;
                transform-origin: 66px 53px;
                animation: wavePulse 1.1s linear infinite;
              }
              .sound-wave.wave2 { animation-delay: 0.18s; }
              .sound-wave.wave3 { animation-delay: 0.36s; }
              @keyframes wavePulse {
