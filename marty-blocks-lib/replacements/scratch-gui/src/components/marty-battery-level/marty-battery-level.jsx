...
class MartyBatteryLevel extends React.Component {
    constructor (props) {
        ...
        mv2Interface.addEventListener('onBattRemainCapacityPercentChange', this.onBatteryPerecentChange);
    }

    componentWillUnmount () {
        // eslint-disable-next-line no-undef
        mv2Interface.removeEventListener('onBattRemainCapacityPercentChange', this.onBatteryPerecentChange);
    }
