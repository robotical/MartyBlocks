...
import LibraryLessonItemComponent from '../components/library-lesson-item/library-lesson-item.jsx';
...
class LibraryItem extends React.PureComponent {
    ...
    render() {
        ...
        let libraryItemComponentJsx = <LibraryItemComponent
        ...
        if (this.props.type === "lesson") {
            libraryItemComponentJsx = <LibraryLessonItemComponent
                collaborator={this.props.collaborator}
                description={this.props.description}
                disabled={this.props.disabled}
                extensionId={this.props.extensionId}
        ...
        return libraryItemComponentJsx;
    }
}
