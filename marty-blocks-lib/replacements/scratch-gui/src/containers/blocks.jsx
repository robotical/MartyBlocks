...
import { createRTTTLPlayer } from '../lib/rtttl-player.js';
...
class Blocks extends React.Component {
    constructor(props) {
        ...
        this.rtttlPlayer = createRTTTLPlayer(); // one per component/app
    }
    componentDidMount() {
        ...
        this.workspace.addChangeListener(this.handleBlocklyEvent);
    }
    ...
    handleBlocklyEvent = (e) => {
        // UI events come through here too
        if (e.type === Blockly.Events.UI && e.element === 'preview_tune') {
            const rtttl = e.newValue;            // what you sent from scratch-blocks
            const blockId = e.blockId;           // optional: the originating block
            // play the tune
            this.rtttlPlayer.stop();
            this.rtttlPlayer.play(rtttl, {
                gapPct: 10,        // % of each note left as silence
    ...
    getToolboxXML() {
        ...
        try {
            ...
            return makeToolboxXML(false, target.targetType, target.id, dynamicBlocksXML,
