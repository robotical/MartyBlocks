...
class Monitor extends React.Component {
    ...
    componentDidMount () {
        ...
        // there is a nasty race-condition happening between updating redux state and
        // rendering content during the first loading of the page. Adding a
        // timeout of 1ms seems to solve that race condition.
