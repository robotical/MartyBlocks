      ...
      .then((soundAsset) => {
        if (soundAsset) {
          ...
          return this.audioEngine
            ...
            .then((soundPlayer) => {
              // Check if sound is fetched properly. There might be the case
              // that sound wasn't fetched but the promise was resolved without error
              if (soundPlayer.buffer.duration < 0.001) {
                throw new Error("Sound is not fetched properly -- there might be a problem with the internet connection.");
              }
            ...
            .catch((e) => {
              ...
              mv2Interface.send_REST(
                "notification/warn-message/This sound requires internet. Please select a pre-loaded sound."
              );
            });
        }
      })
