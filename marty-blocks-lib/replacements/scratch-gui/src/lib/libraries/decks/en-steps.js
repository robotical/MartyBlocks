...
const enImages = {
    ...
    mmCreateImageModel: S3_URL + "create-image-model.png",
    mmCreateAudioModel: S3_URL + "create-audio-model.png",
    mmLoadTMModel: S3_URL + "load-tm-model.png",
    mmChangeModelName: S3_URL + "change-model-name.png",
    mmCollectDataForClass: S3_URL + "collect-data-for-class.png",
    mmTrainModel: S3_URL + "train-model.png",
    mmRunModel: S3_URL + "run-model.png",
    mmSaveModel: S3_URL + "save-model.png",

    mmAIBlocks: S3_URL + "mmAIBlocks.png",
    mmBlocksLoadImageModel: S3_URL + "mmBlocksLoadImageModel.png",
    mmBlocksLoadAudioModel: S3_URL + "mmBlocksLoadAudioModel.png",
