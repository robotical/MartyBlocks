...
const martyBlocksCodingTutorial1 = {
    'type-lesson-marty-blocks-coding-1': {
        id: "type-lesson-marty-blocks-coding-1",
        ...
        description: <FormattedMessage
            ...
            id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.description`}
            values={{}}
        ...
        steps: [
                ...
                description: <FormattedMessage
                    ...
                    defaultMessage={`
                      ...
                      <br /><br /> We'll use them together in a forever loop to help Marty stop walking if something's blocking his path. 
                        `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-1`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                expectedCode: [],
            },
            /* STEP 2 -- if statement explaination*/
           {
                ...
                description: <FormattedMessage
                    ...
                    <br/><br/>Sometimes we only want a part of code to run <b /> if <b /> something else is true. 
                        `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-2`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                nextStepActions: [
                    {
                        type: "HighlightElement",
            ...
            /* STEP 3 -- add if statement block*/
           {
                ...
                description: <FormattedMessage
                   ...
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-3`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                nextStepActions: [
                    {
            ...
            /* STEP 4 -- IR sensor introduction*/
           {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-4`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightElement",
            ...
            /* STEP 5 -- IR diagram*/
           {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-5`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightElement",
             ...
             /* STEP 6 -- add obstacle sensing block.*/
           {
                ...
                description: <FormattedMessage
                    ...
                    `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-6`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightBlocks",
                ...
                /* STEP 7 -- add stop immediately*/
           {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-7`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightBlocks",
             ...
             /* STEP 8 -- add forever loop*/
           {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-8`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightBlocks",
            ...
            /* STEP 9 -- add walking block*/
            {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-9`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightBlocks",
              ...
              /* STEP 10 -- add forever loop */
              {
                ...
                `}
                   description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-10`}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                 nextStepActions: [
                    {
                        type: "HighlightBlocks",
            ...
            /* STEP 11 -- add forever loop */
            {
                ...
                description: <FormattedMessage
                    ...
                    description=""
                    id={`gui.howtos.lessons.type-lesson-marty-blocks-coding-1.step-11`}
                    values={{}}
                >{(nodes) => <span dangerouslySetInnerHTML={{ __html: nodes }} />}</FormattedMessage>,
                expectedCode: [],
            },
